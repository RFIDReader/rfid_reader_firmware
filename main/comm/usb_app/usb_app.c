...
ESP_EVENT_DEFINE_BASE(USB_APP_EVENTS);
esp_event_loop_handle_t usb_app_event_handle;

static const char *TAG = "usb_app";
static uint8_t rx_buf[255 + 1];
...
void tinyusb_cdc_rx_callback(int itf, cdcacm_event_t *event) {
    ...
    /* read */
    esp_err_t ret = tinyusb_cdcacm_read(itf, rx_buf, 255, &rx_size);
    if (ret == ESP_OK) {
